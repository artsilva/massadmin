...
public class MenuMassAnual extends javax.swing.JInternalFrame {
    ...
    public MenuMassAnual() {
        ...
        dfm.setColumnIdentifiers(new Object[]{ "ID", "Nombre", "Apellido", "Rut", "Sector", "Area", "Jefe Area", "Fecha", "Año", "Lugar Incidente", "Detalles" ,"Lesion", "Incidente", "Extremidad", "Paramedico", "Tratamiento", "Comentario" });
    
        Conexion cn = new Conexion();
        rs = cn.ExtraerAtencionesAnual();
        try{
            while(rs.next()){
                dfm.addRow(new Object[]{rs.getInt("id_atencion"), rs.getString("nombre"),rs.getString("apellido"),  rs.getInt("rut"), rs.getString("sector"), rs.getString("area"), rs.getString("jefe_area"),rs.getDate("fecha"),rs.getString("ano"), rs.getString("lugarincidente"), rs.getString("detalles"), rs.getString("lesion"), rs.getString("incidente"), rs.getString("extremidad"), rs.getString("paramedico"), rs.getString("tratamiento"), rs.getString("comentario") });
            }   
        }catch(Exception e){
    ...
    private void btnFiltrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFiltrarActionPerformed
        ...
        if (rdExtremidad.isSelected()){
            ...
            Conexion cn = new Conexion();
            ResultSet rsExtr = cn.ExtraerAtencionAnualExtremidad(extremidad, ano);
            DefaultTableModel dfm = new DefaultTableModel();
            this.grdAnual.setModel(dfm);
            dfm.setColumnIdentifiers(new Object[]{ "ID", "Nombre", "Apellido", "Rut", "Sector", "Area", "Jefe Area", "Fecha"/*, "Año"*/, "Lugar Incidente", "Detalles" ,"Lesion", "Incidente", "Extremidad", "Paramedico", "Tratamiento", "Comentario" });
            try {
                while(rsExtr.next()){
                    dfm.addRow(new Object[]{ rsExtr.getInt("id_atencion"), rsExtr.getString("nombre"),rsExtr.getString("apellido"),  rsExtr.getInt("rut"), rsExtr.getString("sector"), rsExtr.getString("area"), rsExtr.getString("jefe_area"),rsExtr.getDate("fecha"),/*rsExtr.getString("ano"),*/ rsExtr.getString("lugarincidente"), rsExtr.getString("detalles"), rsExtr.getString("lesion"), rsExtr.getString("incidente"), rsExtr.getString("extremidad"), rsExtr.getString("paramedico"), rsExtr.getString("tratamiento"), rs.getString("comentario") });
                }
            } catch (Exception ex) {
                ex.printStackTrace();
            }
        ...
        if (rdTipo.isSelected()){
            grdAnual.setModel(new DefaultTableModel());
            Conexion cn = new Conexion();
            ResultSet rsExtr = cn.ExtraerAtencionAnualTipo(incidente, ano);
            DefaultTableModel dfm = new DefaultTableModel();
            this.grdAnual.setModel(dfm);
            ...
            try {
                while(rsExtr.next()){
                dfm.addRow(new Object[]{ rsExtr.getInt("id_atencion"), rsExtr.getString("nombre"),rsExtr.getString("apellido"),  rsExtr.getInt("rut"), rsExtr.getString("sector"), rsExtr.getString("area"), rsExtr.getString("jefe_area"),rsExtr.getDate("fecha"), rsExtr.getString("lugarincidente"), rsExtr.getString("detalles"), rsExtr.getString("lesion"), rsExtr.getString("incidente"), rsExtr.getString("extremidad"), rsExtr.getString("paramedico"), rsExtr.getString("tratamiento"), rs.getString("comentario") });
                }
            } catch (Exception e) {
        ...
        if (rdArea.isSelected()){
            grdAnual.setModel(new DefaultTableModel());
            Conexion cn = new Conexion();
            ResultSet rsExtr = cn.ExtraerAtencionAnualArea(area, ano);
            DefaultTableModel dfm = new DefaultTableModel();
            this.grdAnual.setModel(dfm);
            dfm.setColumnIdentifiers(new Object[]{ "ID", "Nombre", "Apellido", "Rut", "Sector", "Area", "Jefe Area", "Fecha", "Lugar Incidente", "Detalles" ,"Lesion", "Incidente", "Extremidad", "Paramedico", "Tratamiento", "Comentario"  });
            try {
        ...
        if (rdSector.isSelected()){
            grdAnual.setModel(new DefaultTableModel());
            Conexion cn = new Conexion();
            ResultSet rsExtr = cn.ExtraerAtencionAnualSector(sector, ano);
            DefaultTableModel dfm = new DefaultTableModel();
            this.grdAnual.setModel(dfm);
            dfm.setColumnIdentifiers(new Object[]{ "ID", "Nombre", "Apellido", "Rut", "Sector", "Area", "Jefe Area", "Fecha", "Lugar Incidente", "Detalles" ,"Lesion", "Incidente", "Extremidad", "Paramedico", "Tratamiento", "Comentario" });
            try {
